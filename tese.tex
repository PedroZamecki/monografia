...
\author[fem]{Pedro Zamecki Andrade}

\def\profa{Prof\kern.02em.\kern-.07emª\kern.07em}
\def\dra{Dr\kern-.04em.\kern-.11emª\kern.07em}

% Para TCCs, este comando define o supervisor
\orientador{Prof. Dr. Paulo Andre Vechiatoo de Miranda}

\banca{
  Prof. Dr. Paulo Andre Vechiatoo de Miranda (orientador) -- IME-USP [sem ponto final],
}
...
\begin{dedicatoria}
Eu dedico este trabalho a todos os que me ajudaram a chegar até aqui.
Agradeço a todos os professores, amigos e familiares que me apoiaram
