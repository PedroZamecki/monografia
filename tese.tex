...
\pagestyle{mainmatter}
\input{conteudo/01-industria-brasileira}
\input{conteudo/02-escolha-do-jogo}
\input{conteudo/03-escolha-dos-graficos}
\input{conteudo/04-usp-kart}
\input{conteudo/05-desenvolvimento-do-usp-kart}
